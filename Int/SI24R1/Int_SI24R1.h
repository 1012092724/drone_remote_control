...
#define SI24R1_EN_H HAL_GPIO_WritePin(SI24R1_EN_GPIO_Port, SI24R1_EN_Pin, GPIO_PIN_SET)
#define SI24R1_EN_L HAL_GPIO_WritePin(SI24R1_EN_GPIO_Port, SI24R1_EN_Pin, GPIO_PIN_RESET)
// #define READ_NRF24L01_IRQ HAL_GPIO_ReadPin(SI_IRQ_GPIO_Port, SI_IRQ_Pin) // IRQ主机数据输入

/*****************************************发送接收数据宽度定义***********************************************/
#define TX_ADR_WIDTH   5  // 5字节的地址宽度
#define RX_ADR_WIDTH   5  // 5字节的地址宽度
#define TX_PLOAD_WIDTH 19 // 32字节的用户数据宽度
#define RX_PLOAD_WIDTH 19 // 32字节的用户数据宽度
